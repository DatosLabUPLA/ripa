...
echo "1) Antes de continuar, asegurese de haber creado el dataset gscholar en BigQuery"
echo "2) Asegurese de haber eliminado las tablas pubs, authors y coauthors en el dataset gscholar"
echo "--------------------------"
